...
export class Object3d {
  ...
  constructor(
    ...
    if (objectBuffer === null)
      throw new Error("Position buffer creation error");
  ...
  public InitializeBuffers(): void {
    ...
    this.gl.bufferData(
      ...
      new Float32Array(this.objectBufferArray),
      this.gl.STATIC_DRAW,
    );
    ...
    this.gl.bufferData(
      ...
      new Uint16Array(this.indexBufferArray),
      this.gl.STATIC_DRAW,
    );
  ...
  public draw(_elapsedSeconds: number, programInfo: ProgramInfo): void {
    ...
    this.gl.uniformMatrix4fv(
      ...
      false,
      this.modelMatrix.ToArray(),
    );
    this.gl.drawElements(
      this.gl.TRIANGLES,
      this.indexBufferArray.length,
  ...
  protected createModelMatrix(): Matrix4 {
    const rotation: Matrix4 = Matrix4.Multiply(
      Matrix4.Multiply(this.rotationZMatrix, this.rotationYMatrix),
