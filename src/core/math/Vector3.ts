...
export class Vector3 {
	...
	public static Transform(vec: Vector3, mat: Matrix4): Vector3 {
		const X: number = vec.X * mat.Row0.X + vec.Y * mat.Row1.X + vec.Z * mat.Row2.X;
		const Y: number = vec.X * mat.Row0.Y + vec.Y * mat.Row1.Y + vec.Z * mat.Row2.Y;
		const Z: number = vec.X * mat.Row0.Z + vec.Y * mat.Row1.Z + vec.Z * mat.Row2.Z;
